...
declare module acorn_loose {
    function parse_dammit(input: string, options?: acorn.Options): ESTree.Program;
}

declare module walk {
    function simple(node, visitors, base?, state?): void;
    function recursive(node, state, functions, base?): void;
}
